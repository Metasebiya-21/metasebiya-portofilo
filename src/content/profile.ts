export const profile = {
  name: "Metasebiya Mulugeta",
  role: "Lead Software Engineer",
  headline:
    "Backend & Data Pipelines • Java (Spring Boot), Python • Apache Pulsar • Machine Learning & AI Solutions",
  ...
  highlights: [
    ...
    "Core engineer on MICHU digital lending (uncollateralized loans).",
    "Real-time pipelines with Apache Pulsar / Kafka.",
    "ML projects: OCR for Amharic, recommender, healthcare chatbot.",
  ],
};
